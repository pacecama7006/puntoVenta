...
@section('title', 'Concepto/registrar')
@section('estilos')
	{{-- expr --}}
@endsection
@section('preference')
...
<div class="content-wrapper">
	<div class="page-header">
		<h3 class="page-title">Registrar concepto de Ingreso o Egreso.</h3>
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="{{ route('ptoventa') }}">Panel administrador</a></li>
				<li class="breadcrumb-item"><a href="{{ route('concepts.index') }}">Concepto</a></li>
				<li class="breadcrumb-item active" aria-current="page">Registrar concepto.</li>
			</ol>
		</nav>
	</div>
	{{-- Inicio de fila --}}
		  	...
		  	<div class="card">
			    ...
			    <div class="card-body">
					<div class="d-flex justify-content-between">
                        <h4 class="card-title">Registro de concepto.</h4>
                    </div>

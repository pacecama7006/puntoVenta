...
<div class="content-wrapper">
	<div class="page-header">
		<h3 class="page-title">Registrar movimiento.</h3>
		  	...
		  	<div class="card">
			    ...
			    <div class="card-body">
					<div class="d-flex justify-content-between">
                        <h4 class="card-title">Registro de movimiento.</h4>
                    </div>
                    {!! Form::open(['method' => 'POST', 'route' => 'moves.store', 'class' => 'form-horizontal', 'files' => true]) !!}

...
@section('title', 'Medidas/registrar')
@section('estilos')
	{{-- expr --}}
@endsection
@section('preference')
...
<div class="content-wrapper">
	<div class="page-header">
		<h3 class="page-title">Registrar medida.</h3>
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">Registrar medida.</li>
			</ol>
		</nav>
	</div>
	{{-- Inicio de fila --}}
		  	...
		  	<div class="card">
			    ...
			    <div class="card-body">
					<div class="d-flex justify-content-between">
                        <h4 class="card-title">Registro de medida.</h4>
                    </div>
                    {!! Form::open(['method' => 'POST', 'route' => 'measures.store', 'class' => 'form-horizontal']) !!}

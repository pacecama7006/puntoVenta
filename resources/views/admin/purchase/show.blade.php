...
@section('title','Detalles_de_compra')
@section('styles')
    ...
    <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Detalles de compra {{ $purchase->id }}</li>
            </ol>
        </nav>
    </div>
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                    	<div class="col-md-3 text-center">
                            <label class="form-control-label" for="nombre"><strong>Fecha compra</strong></label>
                            ...
                            <table id="detalles" class="table">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <p align="left">$ {{number_format($purchase->total,2,'.',',')}}</p>
                                        </th>
                                    </tr>

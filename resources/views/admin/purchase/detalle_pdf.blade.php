    ...
    <section>
        <div>
            <table id="faccomprador">
                ...
                <tbody>
                    <tr>
                        <td align="center">{{$purchase->user->name}}</td>
                        <td align="center">{{date('d-m-Y',strtotime($purchase->purchase_date))}}</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div>
            <table id="facproducto">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{number_format($purchaseDetail->quantity,0,'',',')}}</td>
                        <td>{{$purchaseDetail->product->name}}</td>
                        <td align="right">$ {{number_format($purchaseDetail->price,2,'.',',')}}</td>
                        <td align="right">$ {{number_format($purchaseDetail->quantity*$purchaseDetail->price,2,'.',',')}}</td>
                    </tr>
                    @endforeach
                </tbody>
                <tfoot>

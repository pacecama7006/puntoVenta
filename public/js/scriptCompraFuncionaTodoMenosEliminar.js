//SCRIPT ACTUAL AL 4-05-21 FUNCIONA TODO BIEN EN LAS COMPRAS, PERO CON NUEVO SCRIPT QUIERO AGREGAR
...
//Fin del script que funciona todo perfectamente al 4-05-21
//ultimo script actualizado
...
´ //Esto es del codigo que me reconoce el código de barras pero no reconoce eliminar producto
$(document).ready(function() {
    //Inicio Función click
    $("#agregar").click(function() {
        agregar();
...
///ESto es del otro registro que no me encuentra el codigo de barras pero eliimina el producto
$(document).ready(function() {
    $("#agregar").click(function() {
        agregar();
    });

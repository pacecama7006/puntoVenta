(function($) {
    var charts = {
        ...
        ajaxGetPostMonthlyData: function() {
            var urlPath = 'http://' + window.location.hostname + '/graficas/grafica_compra_mes';
            var request = $.ajax({
                method: 'GET',
                url: urlPath
            });
        ...
        createCompletedJobsChart: function(response) {
            var ctx = document.getElementById("compraMensual");
            var myLineChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        pointHitRadius: 20,
                        pointBorderWidth: 2,
                        data: response.compra_total_dato // The response got from the ajax request containing data for the completed jobs in the corresponding months
                    }],
                },
                options: {
                    scales: {

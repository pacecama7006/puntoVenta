...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $role3 = Role::create(['name' => 'Comprador']);
        ...
        Permission::create(['name' => 'sales.index', 'description' => 'Ver listado de ventas'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'sales.edit', 'description' => 'Editar una venta'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'sales.update', 'description' => 'Actualizar una venta'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'sales.create', 'description' => 'Crear una venta'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'sales.destroy', 'description' => 'Eliminar una venta'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'sales.show', 'description' => 'Mostrar detalles de una venta'])->syncRoles([$role1, $role2]);

        Permission::create(['name' => 'sales.pdf_detalle', 'description' => 'Generar el pdf de una venta'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'sales.excel_detalle', 'description' => 'Generar el detalle de una venta en excel'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'sales.print', 'description' => 'Imprimir tickets de venta'])->syncRoles([$role1, $role2]);

        Permission::create(['name' => 'business.index', 'description' => 'Configurar datos del negocio'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'business.update', 'description' => 'Actualizar datos del negocio'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'printer.index', 'description' => 'Configurar datos de la impresora'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'printer.update', 'description' => 'Actualizar datos de la impresora'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'purchases.upload', 'description' => 'Subir imagen de una compra'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'products.status', 'description' => 'Modificar el status de un producto'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'purchases.status', 'description' => 'Modificar el status de una compra'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'sales.status', 'description' => 'Modificar el status de una venta'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'sales.reports.day', 'description' => 'Generar reporte de ventas del día'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'sales.reports.date', 'description' => 'Generar reporte de ventas por rango de fecha'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'sales.report.result', 'description' => 'Generar reportes de ventas'])->syncRoles([$role1, $role2]);

        Permission::create(['name' => 'purchases.reports.purchases.day', 'description' => 'Generar reporte de compras del día'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'purchases.reports.purchases.date', 'description' => 'Generar reporte de compras por rango de fecha'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'purchases.report.purchases.result', 'description' => 'Generar reportes de compras'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'purchases.print', 'description' => 'Imprimir compra en impresora térmica'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'boxes.index', 'description' => 'Ver listado de cajas'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'boxes.edit', 'description' => 'Editar una caja'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'boxes.update', 'description' => 'Actualizar una caja'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'boxes.create', 'description' => 'Crear una caja'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'boxes.destroy', 'description' => 'Eliminar una caja'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'boxes.pdfBoxes', 'description' => 'Generar PDF de cajas'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'boxes.export', 'description' => 'Exportar Excel de cajas'])->syncRoles([$role1, $role2]);

        Permission::create(['name' => 'boxes.reports.corte_diario', 'description' => 'Generar reporte de corte de caja por día'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'boxes.reports.corte_por_fecha', 'description' => 'Generar reporte de corte de caja por fecha'])->syncRoles([$role1, $role2]);

        Permission::create(['name' => 'concepts.index', 'description' => 'Ver listado de concepto'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'concepts.edit', 'description' => 'Editar un concepto'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'concepts.update', 'description' => 'Actualizar un concepto'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'concepts.create', 'description' => 'Crear un concepto'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'concepts.destroy', 'description' => 'Eliminar un concepto'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'concepts.pdfConcepts', 'description' => 'Generar PDF de conceptos de Egresos e Ingresos'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'concepts/export', 'description' => 'Exportar Excel de conceptos de Egresos e Ingresos'])->syncRoles([$role1, $role2]);

        Permission::create(['name' => 'moves.index', 'description' => 'Ver listado de movimientos'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'moves.edit', 'description' => 'Editar un movimiento'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'moves.update', 'description' => 'Actualizar un movimiento'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'moves.create', 'description' => 'Crear un movimiento'])->syncRoles([$role1, $role2]);
